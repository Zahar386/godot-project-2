...
func _physics_process(delta: float) -> void:
	...
	if GameManager.game_situation == 0:
		...
		$Store/LevelBar3/Price.text = str((GameManager.friend_ship_level_3+1)*2)
...
func _on_upgrade_3_pressed() -> void:
	if GameManager.money >= 2 and GameManager.friend_ship_level_3 == 0:
		GameManager.money -= 2
		GameManager.friend_ship_level_3 += 1
		$Store/LevelBar3/Power2.visible = true
		$Buying.play()
	elif GameManager.money >= 4 and GameManager.friend_ship_level_3 == 1:
		GameManager.money -= 4
		GameManager.friend_ship_level_3 += 1
		$Store/LevelBar3/Power3.visible = true
		$Buying.play()
	elif GameManager.money >= 6 and GameManager.friend_ship_level_3 == 2:
		GameManager.money -= 6
		GameManager.friend_ship_level_3 += 1
		$Store/LevelBar3/Power4.visible = true
		$Buying.play()
	elif GameManager.money >= 8 and GameManager.friend_ship_level_3 == 3:
		GameManager.money -= 8
		GameManager.friend_ship_level_3 += 1
